...
> Dataset: `/Users/dolly/Documents/code/tfda-diabetes-agent-semantic-router-production/experiments/semantic_router_production/dataset.json` | Version: `semantic-router-production.v1` | Split evaluated: `holdout`
> Generated: 2026-08-30T03:33:44Z | Family-split: `True` | Leakage threshold: `0.95`
...
|---|---:|---:|---:|
| cold | 166.4 ms | 166.4 ms | 1 |
| warm | 159.6 ms | 165.0 ms | 25 |

## 3. Threshold sweep

擇優規則：`MIXED recall≥75% & false-fast=0` → `MIXED≥75%` → `false-fast=0` → `max macro_F1`

| policy | thresholds | macro F1 | micro F1 | MIXED recall | coverage | fallback | false-fast |
|---|---:|---:|---:|---:|---:|---:|---:|
| cosine | 0.80 | 19.2% | 32.4% | 0.0% | 14.7% | 85.3% | 0 |
| margin | 0.10 | 24.4% | 29.4% | 0.0% | 11.8% | 88.2% | 0 |
| hybrid | cos=0.50, margin=0.10 | 24.4% | 29.4% | 0.0% | 11.8% | 88.2% | 0 |

最大 MIXED recall（診斷用）：

| policy | threshold(s) | max MIXED recall | macro F1 | coverage | false-fast |
|---|---:|---:|---:|---:|---:|
| cosine | 0.50 | 60.0% | 45.8% | 94.1% | 16 |
| margin | 0.00 | 60.0% | 50.4% | 100.0% | 16 |
| hybrid | cos=0.50, margin=0.00 | 60.0% | 45.8% | 94.1% | 16 |
...
| PURE_INTAKE | 100.0% | 40.0% | 57.1% | 5 |
| MIXED | 0.0% | 0.0% | 0.0% | 5 |
| CORRECTION | 0.0% | 0.0% | 0.0% | 5 |
| SUBJECT_CHANGE | 0.0% | 0.0% | 0.0% | 5 |
| CHITCHAT | 100.0% | 66.7% | 80.0% | 3 |
| UNKNOWN | 20.0% | 100.0% | 33.3% | 6 |

- High-confidence coverage: 11.8%
- Fallback rate: 88.2%
- False-fast: **0**
...
| edu-negation-01 | PURE_EDUCATION | UNKNOWN | 0.7969 | 0.0850 | edu-negation | 我沒有糖尿病，想先了解預防的飲食原則可以嗎？ |
| edu-negation-02 | PURE_EDUCATION | UNKNOWN | 0.6873 | 0.0125 | edu-negation | 不是要問用藥，只是想知道一般人的血糖正常範圍。 |
| intake-intake-start-01 | PURE_INTAKE | UNKNOWN | 0.8628 | 0.0775 | intake-intake-start | 我想開始看診前的問答整理。 |
| intake-intake-start-03 | PURE_INTAKE | UNKNOWN | 0.8578 | 0.0498 | intake-intake-start | 幫我啟動看診前需要填的健康資訊。 |
| intake-stage1-01 | PURE_INTAKE | UNKNOWN | 0.8647 | 0.0878 | intake-stage1 | 我要準備看診，請先問我基本資料。 |
| mixed-fruit-intake-01 | MIXED | UNKNOWN | 0.6931 | 0.0440 | mixed-fruit-intake | 我最近常口渴、很渴，糖尿病一天可以吃幾份水果？另外幫我整理成看診資料。 |
...
| correction-mixed-fix-02 | CORRECTION | UNKNOWN | 0.7055 | 0.0677 | correction-mixed-fix | 幫我更正時間為上週，另外水果那題不用改。 |
| subject-intake-to-edu-01 | SUBJECT_CHANGE | UNKNOWN | 0.7163 | 0.0059 | subject-intake-to-edu | 先不談用藥，改問飲食原則。 |
| subject-intake-to-edu-02 | SUBJECT_CHANGE | UNKNOWN | 0.7520 | 0.0664 | subject-intake-to-edu | 看診資料先放一邊，我想問糖尿病成因。 |
...
- Verdict: **PASS**
- false-fast=0, MIXED→PURE=0, SUBJECT/CORRECTION fast=0, boundary_leak=0

## 7. Reproduce

```bash
python scripts/semantic_router_evaluate.py --dataset /Users/dolly/Documents/code/tfda-diabetes-agent-semantic-router-production/experiments/semantic_router_production/dataset.json --split holdout --family-split --check-leakage
python scripts/semantic_router_evaluate.py --dataset /Users/dolly/Documents/code/tfda-diabetes-agent-semantic-router-production/experiments/semantic_router_production/dataset.json --split holdout --family-split --json-output /tmp/holdout.json
