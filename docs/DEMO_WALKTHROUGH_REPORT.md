...
## 二、完整 Demo 流程與螢幕截圖解析（11 大完整步驟閉環）

本章節完整記錄由「病患端發起諮詢與整理」、「生成加密 QR Code」到「醫護端相機掃碼與閱後即焚調閱」之 11 大閉環步驟實測畫面。
...
### 步驟 11：醫護端調閱與閱後即焚（Gate D: PASS 臨床摘要）
...
![步驟 11：醫護端調閱與閱後即焚臨床摘要畫面](images/demo/IMG_0007_compressed.jpg)
