...
IDENTITY_VARIANTS: list[str] = [
    "我是 AI 糖尿病衛教小幫手，不是真人，也不是醫師；內容依 TFDA／國健署衛教文件整理，不提供診斷。可以陪你做衛教、看診前整理和藥袋資訊。個人用藥請諮詢醫師/藥師；若有呼吸困難、胸痛或意識不清，請立即撥打 119。",
    "我是在這裡協助整理資訊的 AI 糖尿病衛教小幫手，不是真人客服、也不是醫師，不提供診斷。回答以 TFDA／國健署衛教文件為依據；個人用藥請諮詢醫師/藥師。若出現呼吸困難、胸痛、意識不清，請立即撥打 119。",
    "你現在是和 AI 糖尿病衛教小幫手對話，不是真人，也不是醫療人員。我會依 TFDA／國健署文件整理衛教與看診資料，不提供診斷；個人用藥請諮詢醫師/藥師。遇到緊急狀況請立即撥打 119。",
]

WELCOME_VARIANTS: list[str] = [
    "您好！我是糖尿病衛教小幫手。今天想先做衛教、查藥袋，還是整理看診資料？直接告訴我就好。",
...
EMPATHY_VARIANTS: list[str] = [
    "抱歉，剛才的說法讓你覺得很制式，謝謝你直接告訴我。我會維持 TFDA／國健署文件依據，改用短一點的方式說。你可以接著問：為什麼會有糖尿病、飲食怎麼吃，或上傳藥袋查詢。",
    "收到你的回饋，謝謝提醒。為了讓內容可靠，我只依 TFDA／國健署衛教文件回答；如果語氣不順，你可以直接說，我再把同一份資訊換個說法。也可以問：為什麼會有糖尿病、飲食怎麼吃。",
    "謝謝你直說，讓你覺得不舒服很抱歉。我是依文件提供衛教的 AI 小幫手，會把重點說清楚，不替你做診斷。你可以問為什麼會有糖尿病、飲食怎麼吃，或上傳藥袋。",
]
